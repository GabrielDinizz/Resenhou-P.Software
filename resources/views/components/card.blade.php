        ...
        <div class="carousel-track-container">
            <div class="carousel-track">
                <div class="carousel-item" data-category="funk">
                    <a href="{{ route('list-eventos', ['evento_categoria' => 'funk']) }}">
                        <div class="circle">
                ...
                <div class="carousel-item" data-category="kpop">
                    <a href="{{ route('list-eventos', ['evento_categoria' => 'kpop']) }}">
                ...
                <div class="carousel-item" data-category="pop">
                    <a href="{{ route('list-eventos', ['evento_categoria' => 'pop']) }}">
                ...
                <div class="carousel-item" data-category="rock">
                    <a href="{{ route('list-eventos', ['evento_categoria' => 'rock']) }}">
